...
\label{sec:MainTrotterScheme}
  ...
  \label{subsec:TrotterDynamics}
    ...
    \begin{figure}
      \centering
      \includegraphics[scale=0.6]{longTimeFloquetFidelity.pdf}
  ...
  \label{subsec:QASMResults}
    ...
    \begin{figure}
      ...
      \begin{subfigure}[b]{1.0\textwidth}
        \centering
        \includegraphics[scale=0.5]{QASMData/qasm_control_pdf_evol.pdf}
      ...
      \begin{subfigure}[b]{1.0\textwidth}
        \centering
        \includegraphics[scale=0.5]{QASMData/qasm_control_pauli_exps.pdf}
      ...
      \begin{subfigure}[b]{1.0\textwidth}
        \centering
        \includegraphics[scale=0.5]{QASMData/qasm_control_pdf_fidelity.pdf}
...
\label{sec:Results}
    ...
    % Here I can compare pulse length of the different trotter steps to support this sentence
    ...
    \begin{figure}
      ...
      \begin{subfigure}[b]{1.0 \textwidth}
        \centering
        \includegraphics[scale=0.5]{DirectTranspilationData/direct_pdf_evol.pdf}
        \caption{Direct transpilation pdf.}
        \label{fig:PdfDirectTransp}
      \end{subfigure}
      \begin{subfigure}[b]{1.0 \textwidth}
        \centering
        \includegraphics[scale=0.5]{BasisEfficientData/basis_efficient_pdf_evol.pdf}
        \caption{Basis efficient pdf.}
        \label{fig:PdfBasis}
      \end{subfigure}
      \begin{subfigure}[b]{1.0 \textwidth}
        \centering
        \includegraphics[scale=0.5]{PulseEfficientData/pulse_efficient_pdf_evol.pdf}
        \caption{Basis efficient pdf.}
        \label{fig:PdfPulse}
      \end{subfigure}
