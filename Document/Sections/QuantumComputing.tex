...
\label{sec:trotter}
  ...
  \noindent whose solution, for time indenependent Hamiltonians, is
  ...
  Fon non-commuting operators, the following identity is true
  ...
  \noindent where $f_k(\hat{H}_1,\hat{H}_2)$ is a function of the commutator of the operators. Since $f_1(\hat{H}_1,\hat{H}_2) = 0$, it is so that
